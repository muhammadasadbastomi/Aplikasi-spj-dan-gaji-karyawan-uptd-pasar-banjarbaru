                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input id="name" type="text" class="form-control form-control-lg @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" required autocomplete="username" autofocus>
                                    @error('username')
