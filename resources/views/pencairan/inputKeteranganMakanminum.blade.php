                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="post">
                                    <div class="form-group m-t-20">
                                        ...
                                        <input type="hidden" class="form-control" name="keperluan" id="keperluan" value="{{$keperluan}}">
                                    </div>
                                    <div class="form-group m-t-20">
                                    ...
                                    <div class="form-group m-t-20">
                                        <label> Jumlah Karyawan Kontrak</label>
                                         : <label for="" class="badge badge-success"> {{$pegawai->count()}} Karyawan (ambil jumlah dari data pegawai))</label>
